...
SELECT snapshot_maker('mimeo_source.snap_test_source_change_col', data_source_id, 'mimeo_dest.snap_test_dest_change_col') FROM dblink_mapping WHERE username = 'mimeo_test';
...
SELECT table_maker('mimeo_source.snap_test_source', data_source_id, 'mimeo_dest.table_test_dest', p_sequences := '{"mimeo_dest.col1_seq"}') FROM dblink_mapping WHERE username = 'mimeo_test';
...
SELECT inserter_maker('mimeo_source.inserter_test_source_empty', 'col3', data_source_id) FROM dblink_mapping WHERE username = 'mimeo_test';
...
SELECT updater_maker('mimeo_source.updater_test_source_empty', 'col3', data_source_id) FROM dblink_mapping WHERE username = 'mimeo_test';
...
SELECT dml_maker('mimeo_source.dml_test_source', data_source_id, 'mimeo_dest.dml_test_dest_multi') FROM dblink_mapping WHERE username = 'mimeo_test';
...
SELECT dml_maker('mimeo_source.dml_test_source_empty', data_source_id) FROM dblink_mapping WHERE username = 'mimeo_test';
...
SELECT logdel_maker('mimeo_source.logdel_test_source', data_source_id, 'mimeo_dest.logdel_test_dest_multi') FROM dblink_mapping WHERE username = 'mimeo_test';
...
SELECT logdel_maker('mimeo_source.logdel_test_source_empty', data_source_id) FROM dblink_mapping WHERE username = 'mimeo_test';
