 ...
 */
CREATE OR REPLACE FUNCTION refresh_inserter(p_destination text, p_debug boolean, p_limit integer DEFAULT 100000) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
 ...
 */
CREATE OR REPLACE FUNCTION refresh_updater(p_destination text, p_debug boolean, p_limit integer DEFAULT 100000) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
PERFORM update_step(v_step_id, 'OK','Initial boundary from '||v_last_value::text||' to '||v_boundary::text);
 ...
 */
CREATE OR REPLACE FUNCTION refresh_dml(p_destination text, p_debug boolean, p_limit int default 100000) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
 ...
 */
CREATE OR REPLACE FUNCTION refresh_logdel(p_destination text, p_debug boolean, p_limit int default 100000) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
